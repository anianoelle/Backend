...
const paidByCustomer = {
    // Function to get paid appointments by customerID
    getPaidByCustomerID: async (req, res) => {
        ...
        const sql = `
            ...
            WHERE 
                a.CustomerID = $1 AND a.Status = 'Paid'
        `;
        ...
        try {
            ...
            console.error('Error fetching paid services for customer:', error);
            res.status(500).json({
                status: 'error',
...
module.exports = paidByCustomer; // Export the controller
